...
license), as a complete package from the IBM alphaWorks site
(available under either a trial or a commercial license), or as a
...
Decimal Arithmetic web page (the URL for the open source files is
also linked from there).


The ICU and alphaWorks packages
-------------------------------

The ICU and alphaWorks packages include the files:

  *  readme.txt (this file)

  *  Either ICU-license.html or alphaWorks-license-files.zip
     (the latter has the 90-day trial license, in multiple languages)
